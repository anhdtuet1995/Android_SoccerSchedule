...
public class FixtureCompetitionAdapter extends FixtureBaseAdapter<CompetitionFixture> {

    public FixtureCompetitionAdapter(Context context, List<String> nameOfCompetition, HashMap<String, List<CompetitionFixture>> dataOfMatch) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        CompetitionFixture fixtureToday = (CompetitionFixture) getChild(groupPosition, childPosition);
