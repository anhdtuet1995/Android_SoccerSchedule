...
import com.uet.anhdt.soccerschedule.utils.StringUtils;
...
public class FixtureToday {

    private FixtureLinks _links;

    public FixtureLinks getLinks() { return this._links; }

    public void setLinks(FixtureLinks _links) { this._links = _links; }
    ...
    public FixtureResult getResult() { return this.result; }

    public void setResult(FixtureResult result) { this.result = result; }
